...
describe('PlayerService', () => {
    ...
    test("addPlayer adds a player to the database", async () => {
        ...
        "googleId", "face", "apple", "mail@mail.com", "sephyneko", "oscar", "pastran", "boludooooo", 100, 1000, 1000, 1, "avatar.jpg", "avatar.jpg", false, false, 1, new Date(2023, 5, 7), true, new Date(2023, 5, 7));
    ...
    test("findPlayerById returns the correct player", async () => {
        const ultimoPlayer = new Player_1.Player("1c08c7de-1bb8-4ac3-8742-6c69099c081d", "googleId", "face", "apple", "mail@mail.com", "sephyneko", "oscar", "pastran", "boludooooo", 100, 1000, 1000, 1, "avatar.jpg", "avatar.jpg", false, false, 1, new Date(2023, 5, 7), true, new Date(2023, 5, 7));
