...
class Player {
    constructor(__id, _googleId, _facebookId, _appleId, _mail, _nickname, _firstname, _lastname, _phrase, _coins, _diamonds, _crystals, _experience, _level, _avatar, _avatarBlock, _hasBattlePass, _hasYearPass, _loginDays, _lastLogin, _isActive, _adsViewed, _createdAt) {
        if (!__id || __id == "0") {
        ...
        this.crystals = new PlayerDiamonds_1.PlayerDiamonds(_crystals).getValue();
